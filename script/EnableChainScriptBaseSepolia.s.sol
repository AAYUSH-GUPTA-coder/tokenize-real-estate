 ...
 */
contract EnableChainScriptBaseSepolia is Script {
    ...
    address public constant REAL_ESTATE_TOKEN_ADDRESS = 0x9768C04C9bC6297bB97ebc7FdE519018A693Bc86; // Address of the RealEstateToken contract on the Base Sepolia chain

    // Address of the cross-chain NFT contract on the destination chain. Actually it is the address of RealEstateToken contract on the destination chain
...
// forge script script/EnableChainScriptBaseSepolia.s.sol:EnableChainScriptBaseSepolia --account defaultKey --sender $WALLET_ADDRESS --rpc-url $BASE_SEPOLIA_RPC_URL --broadcast -vv
